      ...
      <body className="m-0 flex h-screen bg-slate-50 font-sans text-slate-800">
        <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-xl z-20">
          <div className="p-6 border-b border-slate-800">
            <h2 className="text-xl font-bold tracking-wide flex items-center gap-2"><span className="text-blue-400">⚡</span> ClinicOS</h2>
            ...
            <div className="flex items-center gap-6 relative">
              ...
              {showNotifications && (
                <div className="absolute top-10 right-10 w-80 bg-white shadow-2xl rounded-xl border border-slate-100 overflow-hidden">
                  ...
                  <div className="p-4 border-b hover:bg-slate-50 cursor-pointer"><p className="text-sm font-semibold text-red-500">Urgent: Missed Stage</p><p className="text-xs text-slate-500">John Smith missed Dose 2 (HPV).</p></div>
                  <div className="p-4 hover:bg-slate-50 cursor-pointer"><p className="text-sm font-semibold text-blue-600">Bot Alert</p><p className="text-xs text-slate-500">3 new patients registered via Telegram today.</p></div>
                </div>
              )}
